...
class OjcUi(QMainWindow):
    def __init__(self):
        ...
        self._setImages()
        self._setHeaderLabels()
        self._setPrepItemLabels()
        self._setCCLabel()
        self._setSpinBoxes()
        self._onionResultLabels()
        self._cilantroResultLabels()
        self._jalapenosResultLabels()
        self._totalLabels()
    ...
    def _jalapenosResultLabels(self):
        medium = self._get_font("medium")
    ...
    def _cilantroResultLabels(self):
        medium = self._get_font("medium")

        self.brown_cil = QtWidgets.QLabel(self)
        self.brown_cil.setText("0.0 " + "bags")
        ...
        self.white_cil.setText("0.0 " + "bags")
        ...
        self.mild_cil.setText("0.0 " + "bags")
        ...
        self.corn_cil.setText("0.0 " + "bags")
        ...
        self.guac_cil.setText("0.0 " + "bags")
...
class OjcCalcModel:
    ...
    def _calculate_cilantro(self, ingredient):
        if ingredient == 'brown':
            ...
            self._view.brown_cil.setText(str(total) + " bags")
            ...
            cups = value * 2
            total = round((cups / 12), 1)
            self._view.white_cil.setText(str(total) + " bags")
            ...
            cups = value * 2
            total = round((cups / 12), 1)
            self._view.mild_cil.setText(str(total) + " bags")
            ...
            cups = value * 2
            total = round((cups / 12), 1)
            self._view.corn_cil.setText(str(total) + " bags")
            ...
            cups = value * 2.5
            total = round((cups / 12), 1)
            self._view.guac_cil.setText(str(total) + " bags")
...
class OjcCalcCtrl(OjcCalcModel):
    ...
    def _connectSignals(self):
        # calculate onions when spin box is clicked
        ...
        # calculate jalapenos when spin box is clicked
        ...
        # calculate cilantro when spin box is clicked
